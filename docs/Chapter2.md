...
此处仅列出不同数据的计算方法，详细的说明请见[战斗系统：战斗数据](Chapter5.md#战斗数据)一节

- **战斗防御（闪避）**= 2 + [**感知**](Chapter3.md#感知) + [**战场机动**](Chapter3.md#战场机动)×2 + **躲闪** – 负重

- **战斗防御（格挡）**= [**物理强度**](Chapter3.md#物理强度)×2 + **力量** + [**战斗技巧**](Chapter3.md#战斗技巧) + 防御加值

- **体力值** = [**生理耐受**](Chapter3.md#生理耐受)×3 + **体质**

- **移动力** = 10（如果[**战场机动**](Chapter3.md#战场机动)为缺陷则为6）+ **运动** – 负重

- **有效负重**：装备总负重 – **运动**

- **法术效力（专精）**= [**源石技艺适应性**](Chapter3.md#源石技艺适应性) + 对应**专精**

- **护甲值**：根据装备的护甲查阅[*装备：护甲列表*](Chapter8.md#护甲列表)一节

- **机动惩罚**：根据装备的护甲查阅[*装备：护甲列表*](Chapter8.md#护甲列表)一节

- **基础伤害**：根据装备的武器查阅[*装备：武器列表*](Chapter8.md#武器列表) 一节